      ...
      <div className="relative w-full max-w-md px-6 pt-10 pb-8 bg-white shadow-xl ring-1 ring-gray-900/5 sm:rounded-xl sm:px-10">
        <div className="w-full">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-500">Join SoundSphere today</p>
          </div>
              ...
              <div>
                ...
                <div className="mt-1">
                  <input
                    ...
                    className="block w-full px-4 py-3 rounded-md bg-gray-50 border border-gray-200 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-500/20 transition-colors duration-200"
