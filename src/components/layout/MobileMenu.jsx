...
const MobileMenu = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-0 bg-black/40 backdrop-blur-lg transition-all duration-700 ease-out md:hidden ${
      ...
      <div
        ...
        className={`fixed right-0 top-0 h-full w-[80%] max-w-sm shadow-2xl transition-all duration-700 ease-[cubic-bezier(0.34,1.56,0.64,1)] transform md:hidden
          ${isOpen ? 'translate-x-0 rounded-l-3xl' : 'translate-x-[110%]'}
