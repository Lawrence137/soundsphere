        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              {/* Search button */}
              <button className="hidden sm:flex items-center justify-center h-10 w-10 rounded-lg text-gray-500 hover:text-purple-600 hover:bg-purple-50/50 transition-all duration-300">
              ...
              <div className="hidden md:relative md:flex">
                ...
                >
                  <div className="relative">
                    ...
                    <img
                      className="relative h-8 w-8 rounded-full ring-2 ring-white object-cover"
                ...
                {isProfileMenuOpen && (
                  <div className="absolute right-0 mt-12 w-64 rounded-2xl shadow-lg py-2 bg-white/80 backdrop-blur-lg ring-1 ring-black ring-opacity-5 focus:outline-none transform transition-all duration-300 ease-out">
                    ...
                    <Link
                      to="/profile"
                      className="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-purple-50/50 hover:text-purple-600 transition-all duration-300"
                    >
                      <svg className="mr-3 h-5 w-5 text-gray-400 group-hover:text-purple-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <button
                      onClick={logout}
                      className="group flex w-full items-center px-4 py-2 text-sm text-gray-700 hover:bg-purple-50/50 hover:text-purple-600 transition-all duration-300"
                    >
                      <svg className="mr-3 h-5 w-5 text-gray-400 group-hover:text-purple-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
